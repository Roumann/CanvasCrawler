...
export class AnimationComponent<T extends string> {
  ...
  // Used to get the current frame of the animation inside RenderSystem
  get frame() {
  ...
  // TODO not sure about this maybe just add a fucntion like playFrame() and all of this there
  // TODO look into movement system to move the animations or keep IDK??
